...
cars = [
    ...
    {'id': 3, 'charge_percentage': 0, 'min_percentage': 80, 'charge': 0, 'max_charge_kw': 80, 'charge_speed': 22, 'constraints': {"start": 12, "end": 17}},
    ...
    {'id': 9, 'charge_percentage': 0, 'min_percentage': 0, 'charge': 0,  'max_charge_kw': 60, 'charge_speed': 22, 'constraints': {}},
    {'id': 10, 'charge_percentage': 0, 'min_percentage': 0, 'charge': 20, 'max_charge_kw': 60, 'charge_speed': 12, 'constraints': {}},
]
num_chargers = 6
# num_episodes = 500
num_episodes = 1000
